  ...
  <div style="width: 100%">
    ...
    <div :class="`flex items-center ${prefixCls}__table-title-box`">
      ...
      <div :class="`${prefixCls}__toolbar`">
        ...
        <TableSetting :class="`${prefixCls}__toolbar-desktop`" style="white-space: nowrap;" :setting="tableSetting" v-if="showTableSetting" @columns-change="handleColumnChange" @switch-view-style="handleSwitchViewStyle"   />
