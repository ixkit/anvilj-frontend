//@from src/router/routes/index.ts
/*
    replace with new route path which add admin console prefix 
*/
...
const adminRootPath = getAdminConsoleDef().root;
...
export const Oauth2LoginRoute: AppRouteRecordRaw = {
  path: adminRootPath + '/oauth2-app/login',
