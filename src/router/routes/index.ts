...
//@@step
import { webSiteRoutes, RootRoute, LoginRoute, Oauth2LoginRoute, TokenLoginRoute } from '/@/webrouter/routes/index';
export { RootRoute, LoginRoute, Oauth2LoginRoute, TokenLoginRoute };
...
//@@step
const basicRoutes_kept = [LoginRoute, RootRoute, ...mainOutRoutes, REDIRECT_ROUTE, PAGE_NOT_FOUND_ROUTE, TokenLoginRoute, Oauth2LoginRoute];

export const basicRoutes = [...basicRoutes_kept, ...webSiteRoutes];